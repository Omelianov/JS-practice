...
// const salary = [23, 45, 6, 54, 342, 552];
...
// // если нужно увеличить всем зарплату на 20% и округлить её, то используем счетчик

// for (let i = 0; i < salary.length; i += 1) {
//     salary[i] = Math.round(salary[i] * 1.2);
...
// console.log(findMatches([1, 2, 3, 4, 7], 1, 8, 2, 7));
